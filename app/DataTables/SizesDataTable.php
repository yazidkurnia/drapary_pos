...
class SizesDataTable extends DataTable
{
            ...
            ->addColumn('action', function ($row) {
                return '
                    <button type="button"
                        ...
                        data-toggle="tooltip" data-placement="top" title="Edit Ukuran">
                        <i class="fas fa-pencil-alt"></i>
                    </button>
                    <button type="button"
                        class="btn btn-sm btn-icon btn-danger"
                        onclick="confirmDelete(\'' . Crypt::encryptString($row->id) . '\')"
                        data-toggle="tooltip" data-placement="top" title="Hapus Ukuran">
    ...
    public function html(): HtmlBuilder
    {
        $emptyHtml = '
            <div class="dt-empty-state">
                ...
                <h5 class="dt-empty-title">Belum ada data ukuran</h5>
                <p class="dt-empty-desc">Data ukuran yang Anda cari tidak ditemukan.<br>Coba ubah kata kunci pencarian atau tambah ukuran baru.</p>
            </div>
        ';
        ...
        return $this->builder()
            ...
            ->minifiedAjax(route('sizes.index'))
            ->orderBy(1)
    ...
    public function getColumns(): array
    {
        return [
            ...
            Column::make('size_name')->title('Nama Ukuran'),
            Column::make('size_code')->title('Kode Ukuran'),
