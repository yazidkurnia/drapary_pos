...
class UnitsDataTable extends DataTable
{
            ...
            ->addColumn('action', function ($row) {
                return '
                    <button type="button"
                        ...
                        data-toggle="tooltip" data-placement="top" title="Edit Satuan">
                        <i class="fas fa-pencil-alt"></i>
                    </button>
                    <button type="button"
                        class="btn btn-sm btn-icon btn-danger"
                        onclick="confirmDelete(\'' . Crypt::encryptString($row->id) . '\')"
                        data-toggle="tooltip" data-placement="top" title="Hapus Satuan">
    ...
    public function html(): HtmlBuilder
    {
        $emptyHtml = '
            <div class="dt-empty-state">
                ...
                <h5 class="dt-empty-title">Belum ada data satuan</h5>
                <p class="dt-empty-desc">Data satuan yang Anda cari tidak ditemukan.<br>Coba ubah kata kunci pencarian atau tambah satuan baru.</p>
            </div>
        ';
    ...
    public function getColumns(): array
    {
        return [
            ...
            Column::make('unit_code')->title('Kode Satuan'),
