...
class GendersDataTable extends DataTable
{
            ...
            ->addColumn('action', function ($row) {
                return '
                    <button type="button"
                        ...
                        data-toggle="tooltip" data-placement="top" title="Edit Jenis Kelamin">
                        <i class="fas fa-pencil-alt"></i>
                    </button>
                    <button type="button"
                        class="btn btn-sm btn-icon btn-danger"
                        onclick="confirmDelete(\'' . Crypt::encryptString($row->id) . '\')"
                        data-toggle="tooltip" data-placement="top" title="Hapus Jenis Kelamin">
    ...
    public function html(): HtmlBuilder
    {
        $emptyHtml = '
            <div class="dt-empty-state">
                <div class="dt-empty-icon"><i class="fas fa-venus-mars"></i></div>
                <h5 class="dt-empty-title">Belum ada data jenis kelamin</h5>
                <p class="dt-empty-desc">Tambah jenis kelamin baru untuk memulai.</p>
            </div>
        ';
        ...
        return $this->builder()
            ...
            ->minifiedAjax(route('genders.index'))
            ->orderBy(1)
    ...
    public function getColumns(): array
    {
        return [
            ...
            Column::make('gender_name')->title('Jenis Kelamin'),
            Column::make('gender_code')->title('Kode'),
